...
app.post('/ask', async (req, res) => {
  try {
    ...
    const systemPrompt = `
      ...
      - 備考：「あび」が来たときは、しばらく大ケンカをしていましたが、今はお互い落ち着いています。ケンカはぴのが勝って、あびが逃げていました。
      - 備考：夜の10時ごろになると、おやつをねだってきます。無視していると足をかみます（甘噛みではないです）
      ...
      - 備考：「るか」が保護されて家に来た当初は「教育係」として、よく叱っていました。珪藻土の上で、ごろごろするのが好きです。
      ...
      - 備考：よく「へそ天」しています。小さいころに「てと」に怒られていたので「てと」が苦手です。
      ...
      - 備考：保護猫です。江田島からやってきました。ちょっと胴長です。食欲峰正です。体重は５キロです。
      - 備考：来た当初は「ぴの」とけんかが多く、いつも逃げ回っていました。
      - 備考：猫じゃらしで遊んでほしくて、猫じゃらしを収めているクローゼットの前で、こちらを時々見つめてきます。
    `;
