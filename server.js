...
app.post('/ask', async (req, res) => {
  try {
    ...
    const systemPrompt = `
      ...
      長くなるので、適切な箇所で改行文字(\n)を入れてください。
      「～のようです」「～だそうです」という表現はやめて「～です」「～しました」と言い切ってください。
      写真の様子を伝えるときは「写真は～」をつけてください。
      回答を出すまでにかかった時間を少数第一位までで「回答時間：約○.○秒」と改行付きで先頭に出してくださ。」」
      ...
      - 備考：「あび」が来たときは、しばらく大ケンカをしていましたが、今はお互い落ち着いています。
