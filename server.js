...
app.post('/ask', async (req, res) => {
  try {
    ...
    const systemPrompt = `
      ...
      - 備考：「てと」と兄妹です。保護猫で福岡県からやってきました。体重は６キロで男の子らしいプロポーションです。
      ...
      - 備考：「ぴの」と兄妹です。保護猫で福岡県からやってきました。体重は４キロで女の子らしいプロポーションです。
      ...
      - 備考：ちょっと小さい体格で１歳未満にみえます。体重は６キロあり、肥満です。
      ...
      - 備考：保護猫です。江田島からやってきました。ちょっと胴長です。
    `;
